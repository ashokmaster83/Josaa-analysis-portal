...
josaa = 'https://josaa.admissions.nic.in/applicant/seatmatrix/OpeningClosingRankArchieve.aspx'
...
for year in years:
    for round in rounds:
        final_data = josaa_data(year,round)
        file_name = f"{year}-{round}.csv"
        print(f"Saving data for year {year}, round {round} to {file_name}")
